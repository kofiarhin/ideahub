...
| [Universal Agent System](projects/agent-system.md) | Model-agnostic instruction architecture compiled into runtime-native agent files | https://github.com/kofiarhin/agent-system | — | Active; v1.0.0 implemented; deployment safety hardening is next |
