...
| [Memory Sequence Game](projects/memory-sequence-game.md) | Responsive visual sequence-recall browser game | — | — | Exploring; MVP and PRD defined; `memory-game` repository pending |
